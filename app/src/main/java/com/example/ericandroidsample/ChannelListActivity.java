...
public class ChannelListActivity extends AppCompatActivity {
    ...
    // retrieve a list of group channel from server
    protected void get_group_channels() {
        ...
        channelListQuery.next(new GroupChannelListQuery.GroupChannelListQueryResultHandler() {
            ...
            public void onResult(List<GroupChannel> list, SendBirdException e) {
                ...
                Toast.makeText(ChannelListActivity.this, "get group channel", Toast.LENGTH_SHORT).show();
                populate_group_channel_list(list);
            }
        });
    }

    // retrieve a list of open channel from server
    ...
    // showing the group channel list
    protected void populate_group_channel_list(List<GroupChannel> list) {
        Toast.makeText(ChannelListActivity.this, "populate group channel", Toast.LENGTH_SHORT).show();
